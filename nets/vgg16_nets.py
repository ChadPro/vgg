...
def vgg_net(inputs, \
    ...
    with tf.variable_scope(scope):
        ...
        with tf.variable_scope('part_3'):
            ...
            net, w3_3, b3_3 = vgg_conv(net, filter_size=[1,1,256,256], strides=[1,1,1,1], padding='SAME', scope='conv_3', trainable=weights_trainable)
        ...
        with tf.variable_scope('part_4'):
            ...
            net, w4_3, b4_3 = vgg_conv(net, filter_size=[1,1,512,512], strides=[1,1,1,1], padding='SAME', scope='conv_3', trainable=weights_trainable)
        ...
        with tf.variable_scope('part_5'):
            ...
            net, w5_3, b5_3 = vgg_conv(net, filter_size=[1,1,512,512], strides=[1,1,1,1], padding='SAME', scope='conv_3', trainable=weights_trainable)
